...
export type NftCollectionCurrencyStats = {
  ...
  volumePercentByFillsource?: Maybe<
    Array<Maybe<NftFillsourceStatsNumberMetrics>>
  >;
};
...
export type NftCollectionPriceStats = {
  ...
  /** The percentages of total volume partitioned by fillsource over the time frame */
  volumePercentByFillsource?: Maybe<
    Array<Maybe<NftCollectionFillsourceNumberStat>>
  >;
};
...
export type NftPoolFilters = {
  /** For ERC1155 pools, the list of NFT token IDs that are accepted by the pool. */
  acceptedNftTokenIds?: InputMaybe<
...
export type PrimePoolEventData =
  | PrimePoolCacheData
...
export type UnconfirmedEventData =
...
export type StatsCurrency = {
  ...
  volumePercentByFillsource?: InputMaybe<
    Array<InputMaybe<FillsourceStatsFilter>>
  >;
};
...
export type NetworksQuery = {
  __typename?: "Query";
  getNetworks: Array<{ __typename?: "Network"; id: number; name: string }>;
};

export const NetworksDocument = {
  kind: "Document",
  definitions: [
    {
...
} as unknown as DocumentNode<NetworksQuery, NetworksQueryVariables>;
