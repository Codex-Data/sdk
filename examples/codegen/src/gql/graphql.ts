...
export enum BalancesSortAttribute {
  /** Sort by raw token balance amount (default). */
  Balance = 'BALANCE',
...
/** A bucket identifier for grouping and querying webhooks. Provide both fields together so bucket-based queries work correctly. */
export type BucketKeyInput = {
  /** The bucket ID for the webhook. */
  bucketId: Scalars['String']['input'];
  /** The bucket sort key for the webhook. */
  bucketSortKey: Scalars['String']['input'];
};
...
/** Input for creating a token price event webhook. */
export type CreateTokenPriceEventWebhookArgs = {
  /** The recurrence of the webhook. Can be `INDEFINITE` or `ONCE`. */
  alertRecurrence: AlertRecurrence;
  /**
   * Deprecated. Use `bucketKey.bucketId` instead. Existing webhooks created with `bucketId` and `bucketSortkey` will continue to work.
...
export type CreateTokenPriceEventWebhooksInput = {
  /** A list of token price event webhooks to create. */
  webhooks: Array<CreateTokenPriceEventWebhookArgs>;
};

/** Input for creating a token transfer event webhook. */
export type CreateTokenTransferEventWebhookArgs = {
  /** The recurrence of the webhook. Can be `INDEFINITE` or `ONCE`. */
  alertRecurrence: AlertRecurrence;
  /**
   * Deprecated. Use `bucketKey.bucketId` instead. Existing webhofoks created with `bucketId` and `bucketSortkey` will continue to work.
   * @deprecated Use bucketKey.bucketId instead.
   */
  bucketId?: InputMaybe<Scalars['String']['input']>;
  /** An optional bucket key for grouping and querying webhooks. Prefer this over the deprecated flat bucket fields. */
...
export type CreateTokenTransferEventWebhooksInput = {
  /** A list of token transfer event webhooks to create. */
  webhooks: Array<CreateTokenTransferEventWebhookArgs>;
};
...
export type CreateWebhooksInput = {
  ...
  /** Input for creating token price event webhooks. */
  tokenPriceEventWebhooksInput?: InputMaybe<CreateTokenPriceEventWebhooksInput>;
  /** Input for creating token transfer event webhooks. */
  tokenTransferEventWebhooksInput?: InputMaybe<CreateTokenTransferEventWebhooksInput>;
};
...
export type CreateWebhooksOutput = {
  ...
  /** The list of token price event webhooks that were created. */
  tokenPriceEventWebhooks: Array<Maybe<Webhook>>;
  /** The list of token transfer event webhooks that were created. */
  tokenTransferEventWebhooks: Array<Maybe<Webhook>>;
};
...
export type DetailedTokenStats = {
  __typename?: 'DetailedTokenStats';
  /** Number of aggregated buckets specified in input */
  bucketCount?: Maybe<Scalars['Int']['output']>;
  /** The unix timestamp for the last event to happen on the token. */
  lastTransactionAt?: Maybe<Scalars['Int']['output']>;
  ...
  statsType: TokenPairStatisticsType;
  /** The breakdown of stats over a 24 hour window. */
  stats_day1?: Maybe<WindowedDetailedTokenStats>;
  /** The breakdown of stats over an hour window. */
  stats_hour1?: Maybe<WindowedDetailedTokenStats>;
  /** The breakdown of stats over a 4 hour window. */
  stats_hour4?: Maybe<WindowedDetailedTokenStats>;
  /** The breakdown of stats over a 12 hour window. */
  stats_hour12?: Maybe<WindowedDetailedTokenStats>;
  /** The breakdown of stats over a 5 minute window. */
  stats_min5?: Maybe<WindowedDetailedTokenStats>;
  /** The contract address of the token. */
  tokenAddress: Scalars['String']['output'];
  /** The ID of the token (`tokenAddress:networkId`). */
  tokenId: Scalars['String']['output'];
...
/** The duration used to request detailed token stats. */
export enum DetailedTokenStatsDuration {
  Day1 = 'day1',
  Day30 = 'day30',
  Hour1 = 'hour1',
  Hour4 = 'hour4',
...
export type FilterNetworkWalletsInput = {
  ...
  /** Include wallets with these labels. See [`WalletLabel`](/api-reference/enums/walletlabel) for possible values. */
...
export type HoldersInput = {
  ...
  filterContracts?: InputMaybe<Scalars['Boolean']['input']>;
...
export enum LaunchpadTokenProtocol {
  ...
  Baseapp = 'Baseapp',
  /** Protocol Name for Baseapp Creator */
  BaseappCreator = 'BaseappCreator',
  /** Protocol name for BONAD.fun. */
  BonadFun = 'BonadFun',
  ...
  ClankerV4 = 'ClankerV4',
  /** Protocol name for Doppler. */
  Doppler = 'Doppler',
  /** Protocol name for EgoTech. */
  EgoTech = 'EgoTech',
  /** Protocol name for Flaunch. */
  Flaunch = 'Flaunch',
  /** Protocol name for Four.meme. */
  FourMeme = 'FourMeme',
  /** Protocol name for Heaven. */
  HeavenAmm = 'HeavenAMM',
  ...
  Pump = 'Pump',
  /** Protocol Name for Pump Mayhem */
  PumpMayhem = 'PumpMayhem',
  /** Protocol name for Rainbow. */
  Rainbow = 'Rainbow',
  /** Protocol name for LaunchLab and Bonk. */
  RaydiumLaunchpad = 'RaydiumLaunchpad',
  /** Protocol name for TokenMill V2 (EVM). */
  TokenMillEvm = 'TokenMillEVM',
  /** Protocol name for TokenMill V2 (SVM). */
...
export type LiquidityLockConnection = {
  ...
  pairLiquidityData: Array<PairLiquidityData>;
};
...
/** Token transfer direction list condition. */
export type OneOfTokenTransferDirectionCondition = {
  __typename?: 'OneOfTokenTransferDirectionCondition';
  /** The list of transfer directions. */
  oneOf: Array<TokenTransferDirection>;
};

/** Input for token transfer direction list condition. */
...
export type PairLiquidityData = {
  __typename?: 'PairLiquidityData';
  /** The network ID the pair is deployed on. */
  networkId: Scalars['Int']['output'];
...
export type PairMetadata = {
  ...
  /** Wallet pattern data for the quote token, if available. Only populated for launchpad tokens. */
  walletActivity?: Maybe<TokenWalletActivity>;
};
...
export type ProtocolData = ArenaTradeData | PumpData | UniswapV4Data;
...
export type Query = {
  ...
  getDetailedTokenStats?: Maybe<DetailedTokenStats>;
...
export type Subscription = {
  ...
  onDetailedTokenStatsUpdated?: Maybe<DetailedTokenStats>;
...
export type TokenFilters = {
   ...
   * @deprecated Use creatorAddresses string array instead
   */
  creatorAddress?: InputMaybe<Scalars['String']['input']>;
  /** The addresses of the token creators (supports multiple addresses). Max 25 addresses. You cannot provide both creatorAddress and creatorAddresses. */
  creatorAddresses?: InputMaybe<Array<Scalars['String']['input']>>;
...
/** Webhook conditions for a token price event. */
export type TokenPriceEventWebhookCondition = {
  __typename?: 'TokenPriceEventWebhookCondition';
  /** The token contract address the webhook is listening for. */
...
/** Input conditions for a token price event webhook. */
export type TokenPriceEventWebhookConditionInput = {
  /** The contract address of the token to listen for. */
...
/** The direction of a token transfer. */
export enum TokenTransferDirection {
  /** Tokens sent from the address. */
  From = 'FROM',
  /** Tokens received to the address. */
  To = 'TO'
}

/** Webhook conditions for a token transfer event. */
export type TokenTransferEventWebhookCondition = {
  __typename?: 'TokenTransferEventWebhookCondition';
  /** The wallet address the webhook is listening for transfers from or to. */
  address?: Maybe<StringEqualsCondition>;
  /** The directions of the transfer the webhook is listening for. */
  direction?: Maybe<OneOfTokenTransferDirectionCondition>;
  /** The list of network IDs the webhook is listening on. */
  networkId?: Maybe<OneOfNumberCondition>;
  /** The token contract address the webhook is listening for. */
  tokenAddress?: Maybe<StringEqualsCondition>;
...
/** Input conditions for a token transfer event webhook. */
export type TokenTransferEventWebhookConditionInput = {
  /** The wallet address to listen for transfers from or to. */
  address?: InputMaybe<StringEqualsConditionInput>;
  /** The direction of the transfer (TO, FROM). Defaults to [TO, FROM] if not specified. */
  direction?: InputMaybe<OneOfTokenTransferDirectionConditionInput>;
  /** The list of network IDs to listen on. */
  networkId?: InputMaybe<OneOfNumberConditionInput>;
  /** The contract address of the token to listen for. */
  tokenAddress?: InputMaybe<StringEqualsConditionInput>;
};

/** Wallet pattern data showing suspicious or notable wallet activity for a token. */
export type TokenWalletActivity = {
  __typename?: 'TokenWalletActivity';
  /** The number of bundler wallets that hold this token. */
  bundlerCount: Scalars['Int']['output'];
  /** The percentage of token supply held by bundler wallets. */
  bundlerHeldPercentage: Scalars['Float']['output'];
  /** The percentage of token supply held by developer/creator wallet. */
  devHeldPercentage: Scalars['Float']['output'];
  /** The number of insider wallets that hold this token. */
  insiderCount: Scalars['Int']['output'];
  /** The percentage of token supply held by insider wallets. */
  insiderHeldPercentage: Scalars['Float']['output'];
  /** The number of sniper wallets that hold this token. */
...
export type WalletChartInput = {
  ...
  range: RangeInput;
  /** The time frame for each candle. Available options are `60`, `240`, `1D`, `7D`. */
  resolution: Scalars['String']['input'];
  /** The wallet address */
  walletAddress: Scalars['String']['input'];
};
...
export type WalletFunding = {
  __typename?: 'WalletFunding';
  amount: Scalars['String']['output'];
  fundedAt: Scalars['Int']['output'];
  fundedByAddress: Scalars['String']['output'];
  fundedByLabel?: Maybe<Scalars['String']['output']>;
  networkId: Scalars['Int']['output'];
  tokenAddress: Scalars['String']['output'];
  transactionHash: Scalars['String']['output'];
};
...
export enum WebhookType {
  ...
  TokenPriceEvent = 'TOKEN_PRICE_EVENT',
  TokenTransferEvent = 'TOKEN_TRANSFER_EVENT'
}
...
export type WindowedDetailedTokenStats = {
  __typename?: 'WindowedDetailedTokenStats';
  /** The duration used to request detailed token stats. */
