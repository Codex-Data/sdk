...
import {
  ...
  OnEventsCreatedByMakerSubscriptionVariables, OnEventsCreatedByMakerSubscription,
  OnPricesUpdatedSubscriptionVariables, OnPricesUpdatedSubscription,
  ...
  OnLaunchpadTokenEventSubscriptionVariables, OnLaunchpadTokenEventSubscription,
  OnHoldersUpdatedSubscriptionVariables, OnHoldersUpdatedSubscription,
  OnUnconfirmedEventsCreatedSubscriptionVariables, OnUnconfirmedEventsCreatedSubscription,
  OnTokenEventsCreatedSubscriptionVariables, OnTokenEventsCreatedSubscription,
  OnUnconfirmedEventsCreatedByMakerSubscriptionVariables, OnUnconfirmedEventsCreatedByMakerSubscription,
  OnTokenBarsUpdatedSubscriptionVariables, OnTokenBarsUpdatedSubscription,
  OnBalanceUpdatedSubscriptionVariables, OnBalanceUpdatedSubscription,
  OnUnconfirmedBarsUpdatedSubscriptionVariables, OnUnconfirmedBarsUpdatedSubscription,
  OnLaunchpadTokenEventBatchSubscriptionVariables, OnLaunchpadTokenEventBatchSubscription
...
export class Subscribe {
  ...
  onBarsUpdated = (vars: OnBarsUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnBarsUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnBarsUpdated($pairId: String, $quoteToken: QuoteToken) {
...
onLatestTokens = (vars: OnLatestTokensSubscriptionVariables, sink: Sink<ExecutionResult<OnLatestTokensSubscription>>) => this.sdk.subscribe(`subscription OnLatestTokens($id: String, $networkId: Int, $tokenAddress: String) {
...
onDetailedStatsUpdated = (vars: OnDetailedStatsUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnDetailedStatsUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnDetailedStatsUpdated($pairId: String, $tokenOfInterest: TokenOfInterest) {
...
onNftEventsCreated = (vars: OnNftEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnNftEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnNftEventsCreated($address: String, $networkId: Int) {
...
onEventsCreated = (vars: OnEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnEventsCreated($address: String, $id: String, $networkId: Int, $quoteToken: QuoteToken) {
...
onNftPoolEventsCreated = (vars: OnNftPoolEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnNftPoolEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnNftPoolEventsCreated($collectionAddress: String, $exchangeAddress: String, $networkId: Int, $poolAddress: String) {
...
onEventsCreatedByMaker = (vars: OnEventsCreatedByMakerSubscriptionVariables, sink: Sink<ExecutionResult<OnEventsCreatedByMakerSubscription>>) => this.sdk.subscribe(`subscription OnEventsCreatedByMaker($input: OnEventsCreatedByMakerInput!) {
...
onPricesUpdated = (vars: OnPricesUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnPricesUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnPricesUpdated($input: [OnPricesUpdatedInput!]!) {
  onPricesUpdated (input: $input) {
    address, confidence, networkId, poolAddress, priceUsd, timestamp
  }
}`, vars, sink);
onEventLabelCreated = (vars: OnEventLabelCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnEventLabelCreatedSubscription>>) => this.sdk.subscribe(`subscription OnEventLabelCreated($id: String) {
...
`, vars, sink);
onTokenLifecycleEventsCreated = (vars: OnTokenLifecycleEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnTokenLifecycleEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnTokenLifecycleEventsCreated($address: String, $networkId: Int) {
...
onNftAssetsCreated = (vars: OnNftAssetsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnNftAssetsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnNftAssetsCreated($address: String, $networkId: Int, $tokenId: String) {
...
onLaunchpadTokenEvent = (vars: OnLaunchpadTokenEventSubscriptionVariables, sink: Sink<ExecutionResult<OnLaunchpadTokenEventSubscription>>) => this.sdk.subscribe(`subscription OnLaunchpadTokenEvent($input: OnLaunchpadTokenEventInput) {
...
onHoldersUpdated = (vars: OnHoldersUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnHoldersUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnHoldersUpdated($tokenId: String!) {
...
onUnconfirmedEventsCreated = (vars: OnUnconfirmedEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnUnconfirmedEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnUnconfirmedEventsCreated($address: String, $id: String, $quoteToken: QuoteToken) {
...
onTokenEventsCreated = (vars: OnTokenEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnTokenEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnTokenEventsCreated($input: OnTokenEventsCreatedInput!) {
  onTokenEventsCreated (input: $input) {
    events { address, baseTokenPrice, blockHash, blockNumber, data { ... on BurnEventData { amount0, amount0Shifted, amount1, amount1Shifted, tickLower, tickUpper, type }, ... on MintEventData { amount0, amount0Shifted, amount1, amount1Shifted, tickLower, tickUpper, type }, ... on PoolBalanceChangedEventData { amount0, amount0Shifted, amount1, amount1Shifted, liquidity0, liquidity1, protocolFeeAmount0, protocolFeeAmount1, sender, token0, token1, type }, ... on SwapEventData { amount0, amount0In, amount0Out, amount1, amount1In, amount1Out, amountNonLiquidityToken, priceBaseToken, priceBaseTokenTotal, priceUsd, priceUsdTotal, tick, type } }, eventDisplayType, eventType, id, labels { sandwich { label, sandwichType, token0DrainedAmount, token1DrainedAmount }, washtrade { label } }, liquidityToken, logIndex, maker, networkId, quoteToken, timestamp, token0Address, token0PoolValueUsd, token0SwapValueUsd, token0ValueBase, token1Address, token1PoolValueUsd, token1SwapValueUsd, token1ValueBase, transactionHash, transactionIndex, walletAge, walletLabels }, id
  }
}`, vars, sink);
onUnconfirmedEventsCreatedByMaker = (vars: OnUnconfirmedEventsCreatedByMakerSubscriptionVariables, sink: Sink<ExecutionResult<OnUnconfirmedEventsCreatedByMakerSubscription>>) => this.sdk.subscribe(`subscription OnUnconfirmedEventsCreatedByMaker($input: OnUnconfirmedEventsCreatedByMakerInput!) {
...
onTokenBarsUpdated = (vars: OnTokenBarsUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnTokenBarsUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnTokenBarsUpdated($networkId: Int, $tokenId: String) {
  onTokenBarsUpdated (networkId: $networkId, tokenId: $tokenId) {
    aggregates { r1 { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r1D { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r1S { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r5 { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r5S { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r7D { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r15 { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r15S { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r30 { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r30S { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r60 { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r240 { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } }, r720 { t, token { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken }, usd { buyVolume, buyers, buys, c, h, l, liquidity, o, sellVolume, sellers, sells, t, traders, transactions, v, volume, volumeNativeToken } } }, eventSortKey, networkId, pairAddress, pairId, quoteToken, statsType, timestamp, tokenAddress, tokenId
  }
}`, vars, sink);
onBalanceUpdated = (vars: OnBalanceUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnBalanceUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnBalanceUpdated($walletAddress: String!) {
...
onUnconfirmedBarsUpdated = (vars: OnUnconfirmedBarsUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnUnconfirmedBarsUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnUnconfirmedBarsUpdated($pairId: String, $quoteToken: QuoteToken) {
...
onLaunchpadTokenEventBatch = (vars: OnLaunchpadTokenEventBatchSubscriptionVariables, sink: Sink<ExecutionResult<OnLaunchpadTokenEventBatchSubscription>>) => this.sdk.subscribe(`subscription OnLaunchpadTokenEventBatch(
